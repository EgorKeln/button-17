...
//   'I\'s over',
    ...
    "Я сказал, не нажимай на меня",
    "Эй, больше никаких щелчков, пожалуйста?",
    "Ок, теперь ты можешь остановиться",
    "Я не настоящая кнопка",
    "Слишком много щелчков вредно для тебя",
    "Перестань тыкать в меня, это щекочет",
    "Но серьезно, прекрати это",
    "Я не стою того, чтобы на меня нажимать",
    "Что, если я исполню тебе 3 желания?",
    "Ты знаешь, есть дела поважнее",
    "Хватит!",
    "Киберполиция, ПОМОГИТЕ!",
    "Смилуйтесь",
    "Я предупреждаю тебя...",
    "Все кончено",
];
